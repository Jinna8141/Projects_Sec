...
def register(username, master_password):
   # Encrypt the master password before storing it in JSON file
...
# Function to log you in with username and password
       ...
       while True:
           ...
           if password_choice == '1':  # If a user wants to add a password
               ...
               if passwordur == 'RD':
                   ...
                   print("\n[+] Password is randamised\n")

               else:
                   add_password(website, passwordur)
